...
namespace FreaquencyAnalisys {
	...
	public:
		MyForm(void)
		{
			...
			//
			openFileDialog1->Filter = "Текстовый файл (*.txt)|*.txt|Изображение (*.bmp)|*.bmp";
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->chart1->Location = System::Drawing::Point(618, 42);
			this->chart1->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->chart1->Name = L"chart1";
			series1->ChartArea = L"ChartArea1";
			series1->Legend = L"Legend1";
			series1->LegendText = L"Количесвто символов в тексте";
			series1->Name = L"Series1";
			this->chart1->Series->Add(series1);
			this->chart1->Size = System::Drawing::Size(1278, 1003);
			...
			this->menuStrip1->Size = System::Drawing::Size(1896, 33);
			...
			this->файлToolStripMenuItem->Size = System::Drawing::Size(142, 29);
			...
			this->настройкаГистрограммыToolStripMenuItem->Size = System::Drawing::Size(229, 29);
			...
			this->выключитьСеткуToolStripMenuItem->Size = System::Drawing::Size(326, 34);
			...
			this->скрытьКрасныйRКаналToolStripMenuItem->Size = System::Drawing::Size(326, 34);
			...
			this->скрытьЗелёныйGКаналToolStripMenuItem->Size = System::Drawing::Size(326, 34);
			...
			this->скрытьСинийBКаналToolStripMenuItem->Size = System::Drawing::Size(326, 34);
			...
			this->закрытьПриложениеToolStripMenuItem->Size = System::Drawing::Size(203, 29);
			...
			this->label2->Location = System::Drawing::Point(20, 140);
			...
			// trackBar1
			// 
			this->trackBar1->Location = System::Drawing::Point(24, 68);
			this->trackBar1->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->trackBar1->Name = L"trackBar1";
			this->trackBar1->Size = System::Drawing::Size(585, 69);
			this->trackBar1->TabIndex = 4;
			this->trackBar1->Scroll += gcnew System::EventHandler(this, &MyForm::trackBar1_Scroll);
			// 
			// trackBar2
			// 
			this->trackBar2->Location = System::Drawing::Point(24, 165);
			this->trackBar2->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->trackBar2->Name = L"trackBar2";
			this->trackBar2->Size = System::Drawing::Size(585, 69);
			...
			this->textBox1->Location = System::Drawing::Point(24, 272);
			this->textBox1->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->textBox1->Multiline = true;
			this->textBox1->Name = L"textBox1";
			this->textBox1->ReadOnly = true;
			this->textBox1->ScrollBars = System::Windows::Forms::ScrollBars::Vertical;
			this->textBox1->Size = System::Drawing::Size(583, 755);
			...
			this->label4->Location = System::Drawing::Point(33, 214);
			...
			this->label5->Location = System::Drawing::Point(570, 214);
			...
			this->label6->Location = System::Drawing::Point(578, 117);
			...
			this->label7->Location = System::Drawing::Point(20, 248);
			this->label7->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(323, 20);
			...
			this->MaximumSize = System::Drawing::Size(2869, 1631);
			this->MinimumSize = System::Drawing::Size(1906, 998);
			this->Name = L"MyForm";
...
#pragma endregion
	...
	private: void text()
	{
		...
		this->chart1->ChartAreas["ChartArea1"]->AxisX->Maximum = 260;
